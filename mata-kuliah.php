<?php
// Mengambil kode crud php dari folder auth agar kodingan lebih rapih dan clean
include_once "./auth/crud-matakuliah.php";
?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="container">
        <h2 class="text-center mt-4">Tabel Mata Kuliah</h2>
        <div class="row">
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td style="white-space: nowrap;">' . $row['nama'] . '</td>';
                    echo '<td style="white-space: nowrap;">' . $row['kode'] . '</td>';
                    echo '<td>' . $row['deskripsi'] . '</td>';
                    echo '<td style="white-space: nowrap;">
                  <a href="#" class="btn btn-sm btn-primary edit-btn" data-id="' . $row['id'] . '" data-nama="' . $row['nama'] . '" data-kode="' . $row['kode'] . '" data-deskripsi="' . $row['deskripsi'] . '">Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="mata-kuliah.php" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="mata-kuliah.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="edit-kode">Kode Mata Kuliah</label>
    ...
    <!-- CRUD JS -->
    <script src="./auth/crud-matakuliah.js"></script>
</body>
